...
const replace = (name, content) => {
    ...
    window.variables.forEach((element, i) => {
        ...
        // array resolver
        const matched_arr = window.initialHTML.match(regex_1.arrayRegex(element.name));
        if (matched_arr != null) {
...
*/
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.replaceAllRegex = exports.arrayRegex = exports.functionRegex = exports.keyWordRegex = void 0;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const array_1 = __webpack_require__(1);
const boolean_1 = __webpack_require__(4);
const number_1 = __webpack_require__(8);
const string_1 = __webpack_require__(5);
const init_1 = __webpack_require__(6);
const multiReplace_1 = __webpack_require__(7);
const replace_1 = __webpack_require__(2);
/*
